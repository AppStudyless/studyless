...
var $$ = Dom7;
var StudyLess = new Framework7({
    modalTitle: 'StudyLess Login',
...
function loadMessages(snapshot) {
    ...
    StudyLess.initMessages('.page[data-page="messages"]');
}
...
$$('#sendPhoto').on('click', function () {
    StudyLess.prompt('Enter your image URL', function (data) {
...
// Login
function login() {
    StudyLess.prompt('What is your name (or gravatar email)?', function (data) {
        username = data || 'Anon';
        StudyLess.alert('Ok, you are now logged in as ' + username + ' ;)');
